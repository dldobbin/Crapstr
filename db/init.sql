...
insert into locations values ('ChIJAQAAQLgsDogR4nhjwflEdI0',ST_GeographyFromText('point(-87.650023 41.850033)'));
insert into locations values ('ChIJ58kNPA0sDogR6yucEbr6wJ4',ST_GeographyFromText('point(-87.627044 41.835205)'));
insert into locations values ('ChIJ_3C2OkcsDogR1HKmNkyMXPw',ST_GeographyFromText('point(-87.644086 41.837856)'));
insert into locations values ('ChIJu-eVtX0rDogRnAL4r-ucyaM',ST_GeographyFromText('point(-87.616747 41.862269)'));
insert into locations values ('ChIJXcZzy-0sDogRniPFXvsTG0k',ST_GeographyFromText('point(-87.642619 41.867896)'));
insert into locations values ('ChIJxXdiNbwsDogRD9QuRBqUa_4',ST_GeographyFromText('point(-87.631990 41.877576)'));
insert into locations values ('ChIJlUbZ4qMsDogR3tCinMzzKUg',ST_GeographyFromText('point(-87.623708 41.879429)'));
insert into locations values ('ChIJ2WKRwsMsDogRbGtzLAXNAuw',ST_GeographyFromText('point(-87.644221 41.879461)'));
insert into locations values ('ChIJT7Wpyj4tDogRRAPwjAbwk5s',ST_GeographyFromText('point(-87.674224 41.880639)'));
insert into locations values ('ChIJCWjBHBksDogRXpr-YYXUHBw',ST_GeographyFromText('point(-87.629745 41.885151)'));
insert into locations values ('ChIJNVUIeFIrDogRDEzSrRwJnD0',ST_GeographyFromText('point(-87.607628 41.891359)'));
insert into locations values ('ChIJ82J3aie0D4gRS61ZAgdHF1E',ST_GeographyFromText('point(-87.907369 41.974102)'));
insert into locations values ('ChIJu_tp4r4sDogRfYy4Xs5tDwE',ST_GeographyFromText('point(-87.635953 41.879104)'));
insert into locations values ('ChIJ-eSGa8EsDogRLv6BK1PHVGI',ST_GeographyFromText('point(-87.642168 41.879084)'));
insert into locations values ('ChIJBdjcPqUsDogRolOtlb9TRko',ST_GeographyFromText('point(-87.627556 41.883897)'));
insert into locations values ('ChIJNbKQElTTD4gR9grNTX3s-bo',ST_GeographyFromText('point(-87.622879 41.898750)'));
insert into locations values ('ChIJ9Sszh6YsDogRUUo6zu8_TQY',ST_GeographyFromText('point(-87.623313 41.882647)'));
